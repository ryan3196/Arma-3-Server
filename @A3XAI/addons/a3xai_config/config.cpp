...
class CfgA3XAISettings {
	...
	landVehicleList[] = {
							...
							{"Exile_Car_BRDM2_HQ",1},
							{"CUP_B_BRDM2_HQ_CDF",1},
							{"CUP_B_BRDM2_HQ_CZ",1},
							{"CUP_B_BRDM2_HQ_Des",1},
							{"CUP_B_BRDM2_CDF",1},
							{"CUP_B_BRDM2_ATGM_CDF",1},
							{"CUP_B_BRDM2_CZ",1},
							{"CUP_B_BTR60_CDF",1},
							{"CUP_B_BMP2_CDF",1},
							{"CUP_B_BMP_HQ_CDF",1},
							{"CUP_B_BMP2_CZ_Des",1},
							{"CUP_B_BMP_HQ_CZ",1},
							{"CUP_B_BMP_HQ_CZ_Des",1},
							{"CUP_B_BMP2_AMB_CZ_Des",1},
							{"CUP_B_Dingo_CZ_Wdl",1},
							{"CUP_B_Dingo_CZ_Des",1},
							{"CUP_B_Dingo_GER_Des",1},
							{"CUP_B_Dingo_GL_CZ_Des",1},
							{"CUP_B_Dingo_GL_GER_Des",1},
							{"CUP_B_Mastiff_HMG_GB_W",1},
							{"CUP_B_Mastiff_GMG_GB_W",1},
							{"CUP_B_Mastiff_LMG_GB_W",1},
							{"CUP_B_Ridgback_HMG_GB_W",1},
							{"CUP_B_Ridgback_GMG_GB_W",1},
							{"CUP_B_Ridgback_LMG_GB_W",1},
							{"CUP_B_Wolfhound_HMG_GB_W",1},
							{"CUP_B_Wolfhound_GMG_GB_W",1},
							{"CUP_B_Wolfhound_LMG_GB_W",1},
							{"CUP_B_RG31_M2_USMC",1},
							{"CUP_B_RG31_M2_OD_USMC",1},
							{"CUP_B_RG31_M2_GC_USMC",1},
							{"CUP_B_RG31_Mk19_USMC",1},
							{"CUP_B_RG31_Mk19_OD_USMC",1},
							{"CUP_B_RG31E_M2_USMC",1},
							{"CUP_B_M1133_MEV_Desert",1},
							{"CUP_B_M1133_MEV_Woodland",1},
							{"CUP_B_M1133_MEV_Woodland_Slat",1},
							{"Exile_Car_Ifrit",1},
							{"Exile_Car_Hunter",1},
							{"Exile_Car_Strider",1},
