...
if ((!isServer) and hasInterface) then {goto "end"}

goto format["%1", typeof _logic]

#Ryanzombieslogiceasy
Ryanzombiesattackspeed = 1.2
Ryanzombiesattackdistance = 2.2
Ryanzombiesattackstrenth = 1
Ryanzombiesdamage = 0.05
Ryanzombiesdamagecar = 0.01
Ryanzombiesdamageair = 0.005
Ryanzombiesdamagetank = 0.0001
Ryanzombiesdamagecarstrenth = 1
Ryanzombiesdamageairstrenth = 0.5
Ryanzombiesdamagetankstrenth = 0.2
goto "end"

#Ryanzombieslogichard
Ryanzombiesattackspeed = 0.4
Ryanzombiesattackdistance = 2.5
Ryanzombiesattackstrenth = 2
Ryanzombiesdamage = 0.4
Ryanzombiesdamagecar = 0.03
Ryanzombiesdamageair = 0.015
Ryanzombiesdamagetank = 0.003
Ryanzombiesdamagecarstrenth = 2
Ryanzombiesdamageairstrenth = 1.5
Ryanzombiesdamagetankstrenth = 0.6
goto "end"
...
#Ryanzombieslogicthrowdemon
Ryanzombiescanthrowdemon = 1
Ryanzombiescanthrowdistancedemon = 99999
goto "end"

#Ryanzombieslogicthrow25demon
Ryanzombiescanthrowdemon = 1
if (isnil "Ryanzombiescanthrowdistancedemon") then {Ryanzombiescanthrowdistancedemon = 1}
~1 + random 2
Ryanzombiescanthrowdistancedemon = Ryanzombiescanthrowdistancedemon + 25
goto "end"
...
#Ryanzombieslogicthrowtankdemon
Ryanzombiescanthrowtankdemon = 1
Ryanzombiescanthrowtankdistancedemon = 99999
goto "end"

#Ryanzombieslogicthrowtank25demon
Ryanzombiescanthrowtankdemon = 1
if (isnil "Ryanzombiescanthrowtankdistancedemon") then {Ryanzombiescanthrowtankdistancedemon = 1}
~1 + random 2
Ryanzombiescanthrowtankdistancedemon = Ryanzombiescanthrowtankdistancedemon + 25
goto "end"
...
if (ryanzombiescurrentamount < ryanzombiesamount) then {format ["%1",_random] createunit [position _logic, _grp, "this switchmove 'AmovPercMstpSnonWnonDnon_SaluteOut'; [this] exec '\ryanzombies\deprecated\count.sqf'"]}
...
if (ryanzombiescurrentamountdemon < ryanzombiesamountdemon) then {format ["%1",_random] createunit [position _logic, _grp, "this switchmove 'AmovPercMstpSnonWnonDnon_SaluteOut'; [this] exec '\ryanzombies\deprecated\countdemon.sqf'"]}
...
#ryanzombiesfeeddemon
Ryanzombiesfeeddemon = 1
goto "end"
