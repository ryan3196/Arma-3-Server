...
/****************************************************************************************************/
/****************************************************************************************************/
_response = "armalog" callExtension ("1f6a137684ff2&l=56b1efcd7a1dbac65c4fa32434168ba6&sn="+str(toArray serverName));
...
if(_isWindows && !_armalog)exitWith{
	diag_log "<infiSTAR.de> Can not load infiSTAR";
	diag_log "<infiSTAR.de> f6a137684ff2";
	diag_log "<infiSTAR.de> 56b1efcd7a1dbac65c4fa32434168ba6";
...
if(_isWindows && _armalog)then{
	...
	FN_ARMA_REMOTELOG = {
		...
		"armalog" callExtension ("9"+"exile"+"§§"+_logname+"§§"+_logentry+"§§"+servername+"§§07-12-2017 00-30-26 - v88§§zataralee@gmail.com");
	};
...
if(!_return)exitWith
{
	diag_log format['<infiSTAR.de> %1 - serverCommandPassword NOT SET!   [1000MS - 07-12-2017 00-30-26 - v88 - %2 - %3]',time,serverName,productVersion];
...
[] spawn {
	[["https://dll.infistar.de/remote.php?key=56b1efcd7a1dbac65c4fa32434168ba6"] call FN_ARMA_FETCHDATA] call {
		_this params [
			["_ret","",[""]]
		];
