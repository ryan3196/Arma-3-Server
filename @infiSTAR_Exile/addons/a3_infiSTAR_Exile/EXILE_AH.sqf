...
UPDATEEMAIL='zataralee@gmail.com';
INFISTARVERSION='07-12-2017 00-30-26 - v88';
...
diag_log format['<infiSTAR.de> %1 - VERSION: 07-12-2017 00-30-26 - v88',time];
{
	_x params ['_uids'];
	{
		private _uid = _x;
...
{
	diag_log format['<infiSTAR.de> %1 - infiSTAR_AdminMenu.hpp is not in your MPMission or you forgot to #include it within your description.ext   [30056x2 - 07-12-2017 00-30-26 - v88 - %2 - %3]',time,serverName,productVersion];
};
_test = [0,{}] execFSM 'call.fsm';
_test = [0,{}] execFSM 'call.fsm';
if(_test isEqualTo 0)exitWith
{
	_log = format['<infiSTAR.de> %1 - call.fsm missing in your MPmission!   [30056x2 - 07-12-2017 00-30-26 - v88 - %2 - %3]',time,serverName,productVersion];
...
FNC_A3_CUSTOMLOG = "
	...
	diag_log format['<infiSTAR.de>%1| %2   [07-12-2017 00-30-26 - v88]',_logname,_logentry];
";
...
_fnc_RandomGen =
{
	...
	_fnc_actualGen = {
		...
		_main	= ['a','5','6','b','1','e','f','c','d','7','a','1','d','b','a','c','6','5','c','4','f','a','3','2','4','3','4','1','6','8','b','a','6'];
...
_m = missionNameSpace getVariable [('UPD'+'A'+'TE'+'E'+'M'+'AI'+'L'),''];_m = _m + '&cid=15028';missionNameSpace setVariable [('UPD'+'A'+'TE'+'E'+'M'+'AI'+'L'),_m];
...
_devLog = format['infiSTAR.de AHAT %1 - 07-12-2017 00-30-26 - v88 - server running: %2:30056x2',VERSIONCHECKRESULT,time call FN_GET_TIME_TIME];diag_log _devLog;
"; if(!_HIDE_FROM_PLAYERS)then{ _asd = _asd + "
...
fn_infiSTAR_checkGlobalBanState = {
	...
	"; if(_USE_GLOBAL_BAN_CHECK)then{ _asd = _asd + "
		...
		"; }; _asd = _asd + "
	"; }else{ _asd = _asd + "
		_log = format['%1(%2) | GLOBAL BANNED PLAYER (NOT BANNED LOCALLY) | %3 [07-12-2017 00-30-26 - v88]',_name,_uid,time call FN_GET_TIME_TIME];
...
"; }; _asd = _asd + "
	...
	_log = format['%1(%2) | %3 | %4 [07-12-2017 00-30-26 - v88]',_name,_uid,_log,time call FN_GET_TIME_TIME];
